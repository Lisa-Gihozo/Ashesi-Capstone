...
processor_high = Wav2Vec2Processor.from_pretrained("model_high")
model_high = Wav2Vec2ForCTC.from_pretrained("model_high")

processor_medium = Wav2Vec2Processor.from_pretrained("model_medium")
model_medium = Wav2Vec2ForCTC.from_pretrained("model_medium")

processor_baseline = Wav2Vec2Processor.from_pretrained("model_baseline")
model_baseline = Wav2Vec2ForCTC.from_pretrained("model_baseline")
